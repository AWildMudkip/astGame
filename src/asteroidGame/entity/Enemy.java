...
public class Enemy extends Entity {
	...
	public Enemy(double x, double y, double radius, double minVelocity, double maxVelocity, int hitsLeft, int numSplit) {
	...
	public Enemy createSplitAsteroid(double minVelocity, double maxVelocity) {
		...
		return new Enemy(x, y, radius / Math.sqrt(numSplit), minVelocity, maxVelocity, hitsLeft - 1, numSplit);
	}
